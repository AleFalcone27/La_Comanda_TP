...
$app->group('/mesa', function(RouteCollectorProxy $group){
  ...
  $group->get('[/]', \MesaControles::class . ':TraerTodos')->add(new AccesoMiddleware([Roles::SOCIO->value, Roles::MOZO->value]));
  $group->get('/masUsada', \MesaControles::class . ':MasUsada')->add(new AccesoMiddleware([Roles::SOCIO->value]));
  $group->get('/facturacion', \MesaControles::class . ':MenosFacturo')->add(new AccesoMiddleware([Roles::SOCIO->value]));
  $group->get('/facturacionFechas', \MesaControles::class . ':FacturoFechas')->add(new AccesoMiddleware([Roles::SOCIO->value]));
